...
},
{
  ...
  "level": "2",
  "url": "sec-Extreme-values.html#def-increasing-decreasing",
  "type": "Definition",
  "number": "219",
  "title": "Increasing and Decreasing Functions.",
  "body": " Increasing and Decreasing Functions   If the graph of a function rises from left to right over an interval , it is said to be increasing on . If the graph of a function drops from left to right over an interval , it is said to be decreasing on . Let a function be defined on an interval , and let denote numbers in .     is increasing on if for .     is decreasing on if for .     is constant on if for .     "
},
{
...
},
{
  ...
  "body": " 3.4 Summary of Graphical Methods   This section combines our tools for evaluating first and second derivatives to form a comprehensive, step-by-step strategy for analyzing and drawing accurate function curves.    Method for Sketching Graphs  To systematically analyze and sketch the graph of a function , follow these steps:   Determine the domain and analyze the continuity of .    Find the -intercepts and -intercept.    Compute the first derivative and second derivative .    Find the critical points of the function.    Determine the intervals of increase and decrease, and locate local (relative) extrema.    Find the candidate inflection points.    Determine the intervals of concavity.    Identify vertical, horizontal, or slant asymptotes, if any exist.    Sketch the graph by plotting the key points and connecting them according to the established behaviors.        Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       1. Domain and Continuity: As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.   2. Intercepts:    The -intercept is found at , giving the coordinate point .    Setting and solving yields three real roots near , , and .      3. Derivatives:      4. Critical Points: Setting : The interior critical numbers are and .   5. Relative Extrema: We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Increasing  Decreasing  Increasing    By the First Derivative Test, has a local maximum at with value , and a local minimum at with value .   6. Inflection Points and Concavity: Setting gives .  On , , so the graph is concave down ( ).  On , , so the graph is concave up ( ).  Since concavity changes direction, is a point of inflection.   7. Sketch the Graph: Plotting the turning points and inflection point yields the curve below:   The graph of .   A cubic polynomial with local maximum at (-3,15), inflection point at (-1,-1), and local minimum at (1,-17).         Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain and Continuity  As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.    Intercepts     The -intercept is found at , giving the coordinate point .    Setting means solving . By factoring, we find , yielding the -intercepts at and .       Derivatives        Critical Points  Setting : The critical numbers are and .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Increasing  Decreasing  Increasing    By the First Derivative Test, has a local maximum at with value , and a local minimum at with value .    Inflection Points and Concavity  Setting gives .  On , , so the graph is concave down ( ).  On , , so the graph is concave up ( ).  Since concavity changes direction, is a point of inflection.    Sketch the Graph  Plotting key features yields the curve below:    A cubic polynomial with local maximum at (-1,4), inflection point at (0,2), and local minimum at (1,0).          Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain and Continuity  As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.    Intercepts     The -intercept is at , giving the point .    Setting yields . This provides three distinct -intercepts at , , and .       Derivatives        Critical Points  Setting the first derivative to zero: The critical numbers are , , and .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval        Sign of        Behavior of  Decreasing  Increasing  Decreasing  Increasing    By the First Derivative Test, has local minima at and with value . It has a local maximum at with value .    Inflection Points and Concavity  Setting yields .  On and , (concave up ).  On , (concave down ).  The inflection points are located at and .    Sketch the Graph  Plotting the critical points and checking structural behaviors results in the W-shaped curve below:    A W-shaped quartic polynomial with local minima at (-1,-1) and (1,-1), a local maximum at (0,0), and inflection points near x = -0.58 and x = 0.58.          Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain and Continuity  As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.    Intercepts     The -intercept is found at , giving the coordinate point .    Setting yields . This provides two distinct -intercepts at and .       Derivatives        Critical Points  Setting the first derivative to zero: The critical numbers are and .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Decreasing  Increasing  Decreasing    By the First Derivative Test, has a local minimum at with value , and a local maximum at with value .    Inflection Points and Concavity  Setting yields .  On , , so the graph is concave up ( ).  On , , so the graph is concave down ( ).  Since the concavity changes direction, the inflection point is located at .    Sketch the Graph  Plotting key features yields the cubic curve below:    A cubic polynomial with a local minimum at (0,0), an inflection point at (2, 2.67), a local maximum at (4, 5.33), and an x-intercept at (6,0).          Graph the function given by:     Determine the domain, continuity, and asymptotic behavior of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain, Continuity, and Asymptotes  The domain of consists of all real numbers, , and the function is continuous everywhere. As , . By L'Hôpital's Rule, the behavior as is evaluated as: Thus, there is a horizontal asymptote at as .    Intercepts     The -intercept is found at , yielding the coordinate point .    Setting means solving . Since for all real values, the only solution is . The single -intercept is at .       Derivatives  Using the Product Rule:      Critical Points  Setting the first derivative to zero: Since , the only critical number is .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval      Sign of      Behavior of  Decreasing  Increasing    By the First Derivative Test, has a local minimum at with value .    Inflection Points and Concavity  Setting yields .  On , , so the graph is concave down ( ).  On , , so the graph is concave up ( ).  Since the concavity changes direction, the inflection point is located at .    Sketch the Graph  Plotting key features yields the graph below, showing the tail flattening toward the negative x-axis:    The graph of x times e^x showing a horizontal asymptote at y=0 on the left, an inflection point at (-2, -0.271), a minimum point at (-1, -0.368), and passing through the origin.          The first derivative of a function is given by .  At what points, if any, does the graph of have a local maximum, local minimum, or inflection point?  Sketch the general shape of the graph.       Local Extrema and Inflection Points  To find the critical numbers, we set the first derivative equal to zero: The critical numbers are and .  We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Decreasing  Increasing  Decreasing    By the First Derivative Test, has a local minimum at and a local maximum at .  To find inflection points, we compute the second derivative: Setting yields . Since for (concave up) and for (concave down), the graph has an inflection point at .    General Shape Sketch  Plotting the general behavior yields a cubic curve extended to explicitly cross the x-axis:    A cubic polynomial shape with a local minimum at x = -4, an inflection point at the origin, and a local maximum at x = 4, crossing the x-axis at three points.          The first derivative of a function is given by .  At what points, if any, does the graph of have a local maximum, local minimum, or inflection point?  Sketch the general shape of the graph.       Local Extrema and Inflection Points  Setting the first derivative equal to zero: The critical numbers are , , and .  We perform a sign analysis on across the intervals:    Interval        Sign of        Behavior of  Decreasing  Increasing  Decreasing  Increasing    By the First Derivative Test:  Local minima occur at and .  A local maximum occurs at .    To evaluate concavity, expand and find : Setting and solving yields critical values at and . The graph has two inflection points at and .    General Shape Sketch  Plotting the critical key frames yields a classic W-shaped quartic curve extended to pass through the x-axis:    A W-shaped quartic polynomial graph featuring local minima at x = -1 and x = 2, and a local maximum at x = 0, extended to rise past the x-axis on both ends.        "
},
{
...
{
  "id": "ex-graphing-cubic-two",
  "level": "2",
  "url": "sec-Summary-of-Graphical-Methods.html#ex-graphing-cubic-two",
  "type": "Checkpoint",
  "number": "258",
  "title": "",
  "body": "  Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain and Continuity  As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.    Intercepts     The -intercept is found at , giving the coordinate point .    Setting means solving . By factoring, we find , yielding the -intercepts at and .       Derivatives        Critical Points  Setting : The critical numbers are and .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Increasing  Decreasing  Increasing    By the First Derivative Test, has a local maximum at with value , and a local minimum at with value .    Inflection Points and Concavity  Setting gives .  On , , so the graph is concave down ( ).  On , , so the graph is concave up ( ).  Since concavity changes direction, is a point of inflection.    Sketch the Graph  Plotting key features yields the curve below:    A cubic polynomial with local maximum at (-1,4), inflection point at (0,2), and local minimum at (1,0).       "
},
{
  "id": "ex-graphing-quartic",
  "level": "2",
  "url": "sec-Summary-of-Graphical-Methods.html#ex-graphing-quartic",
  "type": "Checkpoint",
  "number": "259",
  "title": "",
  "body": "  Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain and Continuity  As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.    Intercepts     The -intercept is at , giving the point .    Setting yields . This provides three distinct -intercepts at , , and .       Derivatives        Critical Points  Setting the first derivative to zero: The critical numbers are , , and .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval        Sign of        Behavior of  Decreasing  Increasing  Decreasing  Increasing    By the First Derivative Test, has local minima at and with value . It has a local maximum at with value .    Inflection Points and Concavity  Setting yields .  On and , (concave up ).  On , (concave down ).  The inflection points are located at and .    Sketch the Graph  Plotting the critical points and checking structural behaviors results in the W-shaped curve below:    A W-shaped quartic polynomial with local minima at (-1,-1) and (1,-1), a local maximum at (0,0), and inflection points near x = -0.58 and x = 0.58.       "
},
{
  "id": "ex-graphing-cubic-rational",
  "level": "2",
  "url": "sec-Summary-of-Graphical-Methods.html#ex-graphing-cubic-rational",
  "type": "Checkpoint",
  "number": "260",
  "title": "",
  "body": "  Graph the function given by:     Determine the domain and continuity of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain and Continuity  As a polynomial function, the domain of is all real numbers, , and it is continuous everywhere.    Intercepts     The -intercept is found at , giving the coordinate point .    Setting yields . This provides two distinct -intercepts at and .       Derivatives        Critical Points  Setting the first derivative to zero: The critical numbers are and .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Decreasing  Increasing  Decreasing    By the First Derivative Test, has a local minimum at with value , and a local maximum at with value .    Inflection Points and Concavity  Setting yields .  On , , so the graph is concave up ( ).  On , , so the graph is concave down ( ).  Since the concavity changes direction, the inflection point is located at .    Sketch the Graph  Plotting key features yields the cubic curve below:    A cubic polynomial with a local minimum at (0,0), an inflection point at (2, 2.67), a local maximum at (4, 5.33), and an x-intercept at (6,0).       "
},
{
  "id": "ex-graphing-exponential-product",
  "level": "2",
  "url": "sec-Summary-of-Graphical-Methods.html#ex-graphing-exponential-product",
  "type": "Checkpoint",
  "number": "261",
  "title": "",
  "body": "  Graph the function given by:     Determine the domain, continuity, and asymptotic behavior of .  Find the - and -intercepts.  Find and .  Find the critical points.  Determine intervals of increase and decrease, and locate relative extrema.  Find inflection points and determine concavity.  Sketch the graph.       Domain, Continuity, and Asymptotes  The domain of consists of all real numbers, , and the function is continuous everywhere. As , . By L'Hôpital's Rule, the behavior as is evaluated as: Thus, there is a horizontal asymptote at as .    Intercepts     The -intercept is found at , yielding the coordinate point .    Setting means solving . Since for all real values, the only solution is . The single -intercept is at .       Derivatives  Using the Product Rule:      Critical Points  Setting the first derivative to zero: Since , the only critical number is .    Relative Extrema  We analyze the sign changes of across the domain intervals:    Interval      Sign of      Behavior of  Decreasing  Increasing    By the First Derivative Test, has a local minimum at with value .    Inflection Points and Concavity  Setting yields .  On , , so the graph is concave down ( ).  On , , so the graph is concave up ( ).  Since the concavity changes direction, the inflection point is located at .    Sketch the Graph  Plotting key features yields the graph below, showing the tail flattening toward the negative x-axis:    The graph of x times e^x showing a horizontal asymptote at y=0 on the left, an inflection point at (-2, -0.271), a minimum point at (-1, -0.368), and passing through the origin.       "
},
{
  "id": "ex-analysis-derivative-one",
  "level": "2",
  "url": "sec-Summary-of-Graphical-Methods.html#ex-analysis-derivative-one",
  "type": "Checkpoint",
  "number": "262",
  "title": "",
  "body": "  The first derivative of a function is given by .  At what points, if any, does the graph of have a local maximum, local minimum, or inflection point?  Sketch the general shape of the graph.       Local Extrema and Inflection Points  To find the critical numbers, we set the first derivative equal to zero: The critical numbers are and .  We analyze the sign changes of across the domain intervals:    Interval       Sign of       Behavior of  Decreasing  Increasing  Decreasing    By the First Derivative Test, has a local minimum at and a local maximum at .  To find inflection points, we compute the second derivative: Setting yields . Since for (concave up) and for (concave down), the graph has an inflection point at .    General Shape Sketch  Plotting the general behavior yields a cubic curve extended to explicitly cross the x-axis:    A cubic polynomial shape with a local minimum at x = -4, an inflection point at the origin, and a local maximum at x = 4, crossing the x-axis at three points.       "
},
{
  "id": "ex-analysis-derivative-two",
  "level": "2",
  "url": "sec-Summary-of-Graphical-Methods.html#ex-analysis-derivative-two",
  "type": "Checkpoint",
  "number": "263",
  "title": "",
  "body": "  The first derivative of a function is given by .  At what points, if any, does the graph of have a local maximum, local minimum, or inflection point?  Sketch the general shape of the graph.       Local Extrema and Inflection Points  Setting the first derivative equal to zero: The critical numbers are , , and .  We perform a sign analysis on across the intervals:    Interval        Sign of        Behavior of  Decreasing  Increasing  Decreasing  Increasing    By the First Derivative Test:  Local minima occur at and .  A local maximum occurs at .    To evaluate concavity, expand and find : Setting and solving yields critical values at and . The graph has two inflection points at and .    General Shape Sketch  Plotting the critical key frames yields a classic W-shaped quartic curve extended to pass through the x-axis:    A W-shaped quartic polynomial graph featuring local minima at x = -1 and x = 2, and a local maximum at x = 0, extended to rise past the x-axis on both ends.       "
},
{
  ...
  "type": "Section",
  "number": "",
  "title": "3.5 Optimization",
  "body": " 3.5 Optimization   Optimization problems represent one of the most direct and practical applications of differential calculus. In these problems, our objective is to find the most efficient solution to a real-world scenario by identifying either the absolute maximum value (such as maximizing area, volume, or profit) or the absolute minimum value (such as minimizing material cost, waste, or time).  The core workflow for solving any applied optimization problem relies on a structured, multi-step calculus framework:    A Strategy for Solving Max-Min Problems  When addressing optimization problems, use the following structured approach:     Draw and label a picture. Optimization problems often involve geometry. Draw a picture of the situation. Include any information you are given in the problem. Identify the quantities under your control and assign variables to them.     Find the objective function. What is the quantity you want to maximize or minimize? Write a formula for it in terms of the variables in your picture.     Identify the constraints. If your objective function has more than one variable, you will need to use one or more constraints in the problem to write equations that relate the variables together.     Reduce the objective function to one variable. Solve each of the constraint equations for one of the variables and substitute this into the objective function. At the end, the objective function should contain just one variable.     Identify the domain of the objective function. Now that your objective function has a single variable, what values of that variable make sense in the problem? Think about what the variable means in the problem for example, lengths cannot be negative. There may be both a lower bound and an upper bound for meaningful values of the variable; if so, make sure you identify both of them. If the domain has both a lower and an upper bound, and the endpoints of this interval do not cause any mathematical problems in the objective function (such as division by zero), consider including the endpoints even if they don't quite make sense in the problem; this will allow you to use the Closed Interval Method in step 8.     Differentiate the objective function. Find the derivative of the objective function with respect to your chosen variable.     Find the critical numbers. Critical numbers are values of the variable that cause the derivative to equal zero or be undefined. These numbers are potential local maxima or minima. Ignore any critical numbers that are outside the domain of the objective function.     Test the critical numbers (and possibly the endpoints of the domain). The critical numbers are not automatically the answer. You need to test each one to see if it's a local minimum, a local maximum, or neither. Usually you can use one of the following tests:     Closed Interval Method.  Requirements: The domain of the objective function must be a closed, bounded interval (that is, an interval that has endpoints on both ends, and includes those endpoints). Test: Evaluate the objective function at all critical numbers and at the endpoints of the domain, and choose the largest value (if you are maximizing) or the smallest value (if you are minimizing).     First Derivative Test.  Requirements: There must be only one critical number in the domain. Test: Evaluate the first derivative of the objective function at two numbers in the domain, one of which is less than the critical number and the other of which is greater than the critical number. If the first derivative is positive to the left of the critical number and negative to the right, then the critical number represents the absolute maximum. If the first derivative is negative to the left of the critical number and positive to the right, then the critical number represents the absolute minimum.     Second Derivative Test.  Requirements: There must be only one critical number in the domain. Test: Find the second derivative of the objective function and evaluate it at the critical number. If this value is negative, then the critical number represents the absolute maximum. If the value is positive, then the critical number represents the absolute minimum.       Answer the question. The critical number itself may not be the answer to the question. Reread the question to see exactly what it is asking for. If it is asking for the dimensions of a rectangle, for example, make sure you give the width and height of the rectangle, not just the area. And don't forget units!        A hobby store has ft of fencing to fence off a rectangular area for an electric train in one corner of its display room. The two sides up against the wall require no fence. What dimensions of the rectangle will maximize the area? What is the maximum area?   A rectangular region enclosed in the top-right corner of a room, labeled with width x and length y, with the outer sides representing the fence.       We apply our structured strategy to optimize the corner layout:     Draw and label a picture. Let represent the width of the enclosed display and represent its length. Because the layout sits in a corner, only one width side and one length side require actual fencing.     Find the objective function. We want to maximize the total floor area, :      Identify the constraints. The structural boundary is limited by our total physical fencing length:      Reduce the objective function to one variable. Isolate in the constraint equation to get . Substituting this expression back into our area equation creates a single independent variable target:      Identify the domain of the objective function. Length parameters must remain positive, meaning . Because the fence total is capped at ft, . This limits our mathematical search scope to the closed domain interval .     Differentiate the objective function. Taking the first derivative with respect to yields:      Find the critical numbers. Setting the derivative to zero: The value is our single interior critical number.     Test the critical numbers. Applying the Closed Interval Method across our domain boundary points:  sq ft  sq ft  sq ft  The mathematical maximum occurs when .     Answer the question. Setting ft requires a corresponding length side of ft.  The optimal dimensions for the train enclosure are 10 ft by 10 ft , producing an absolute maximum area of 100 sq ft .        From a square piece of cardboard measuring in. by in., square corners are cut out so that the sides can be folded up to make an open-top box. What dimensions will yield a box with the maximum volume? What is the maximum volume?    A square sheet of cardboard with corners marked as small squares of side length x. Dashed lines indicate where the flaps fold up to form a box.     A 3D perspective drawing of an open-top rectangular box with height x and base dimensions labeled 8 minus 2x.       We execute our step-by-step max-min problem-solving strategy:     Draw and label a picture. Let represent the side length of the square corners being removed. When the four flaps are folded up along the dashed lines, becomes the absolute vertical height of the resulting open box.     Find the objective function. The volume of a rectangular prism is given by:      Identify the constraints. The initial length and width of the cardboard sheet are both inches. Cutting out two corners of size from each dimension reduces both the remaining interior base length and width to .     Reduce the objective function to one variable. Substituting our expressions for height, width, and length into the volume formula leaves us with a single independent variable equation:      Identify the domain of the objective function. The cutout height must be positive ( ). Additionally, because you cannot cut out more than half of the total width of the cardboard sheet, . The continuous closed domain interval is .     Differentiate the objective function. Taking the derivative with respect to :      Find the critical numbers. We set the first derivative to zero and factor the expression: This reveals critical numbers at and . Both values lie within our established interval.     Test the critical numbers. We use the Closed Interval Method to evaluate the volume output:  cubic inches.  cubic inches.  cubic inches.  The maximum volume is generated at the peak value .     Answer the question. The optimal height is in. The base dimensions are:   The maximum volume is achieved when the box has dimensions of 5.33 in. by 5.33 in. by 1.33 in. , yielding a total maximum volume of 9.48 cubic inches (or exactly ).         A container firm is designing an open-top rectangular box, with a square base, that will hold . What dimensions yield the minimum surface area? What is the minimum surface area?   A 3D perspective vector sketch of an open-top rectangular box with a square base of sides x by x and height h.       We apply our structured strategy to minimize structural material:     Draw and label a picture. Let represent the side length of the square base, and let represent the vertical height of the box.     Find the objective function. We want to minimize the total surface area, . Since the box is open-top, it consists of one square base and four identical vertical sides:      Identify the constraints. The volume of the box is fixed at :      Reduce the objective function to one variable. Isolating in the volume constraint gives . Substituting this into our surface area equation gives:      Identify the domain of the objective function. The base dimension must be positive, and there is no upper algebraic restriction. Thus, the physical domain is the open interval .     Differentiate the objective function. Taking the first derivative with respect to yields:      Find the critical numbers. Setting the derivative equal to zero: The value is our single interior critical number.     Test the critical numbers. We apply the Second Derivative Test: Evaluating at our critical number: . Because the second derivative is positive, the graph is concave up, confirming that provides an absolute minimum.     Answer the question. Substituting back into our constraint formula yields the height: The minimum surface area value is:   The optimal dimensions are a base of 6 cm by 6 cm and a height of 3 cm , yielding a minimum surface area of 108 cm .       Minimize Perimeter    What is the smallest perimeter possible for a rectangle whose area is and what are its dimensions?   A simple rectangle with width labeled x and height labeled y, illustrating the perimeter optimization parameters.       We execute our step-by-step max-min strategy:     Draw and label a picture. Let represent the width of the rectangle, and let represent its height.     Find the objective function. We want to minimize the total perimeter, :      Identify the constraints. The area of the rectangular region is fixed at :      Reduce the objective function to one variable. Solving the constraint equation for yields . Substituting this into the perimeter equation gives:      Identify the domain of the objective function. The physical length must be strictly greater than zero, with no upper restriction. The domain is the open interval .     Differentiate the objective function. Differentiating with respect to gives:      Find the critical numbers. Setting the derivative to zero: (We discard the negative root since it falls outside our geometric domain).     Test the critical numbers. We apply the First Derivative Test around our critical number on the interval :  For , test : (decreasing).  For , test : (increasing).  Because the derivative switches from negative to positive, is an absolute minimum point.     Answer the question. Using our constraint equation, the remaining side is . The absolute minimum perimeter value is:   The smallest possible perimeter is 16 inches , achieved by a square with dimensions of 4 in. by 4 in.        River Fence Optimization    A farmer has ft of fencing and wants to fence off a rectangular field that borders a straight river. He needs no fence along the river. What are the dimensions of the field that has the largest area?   A rectangular plot bordering a straight blue river on top. The three sides of fencing are labeled with width x and length y.       We apply our structured max-min strategy to maximize the pasture area:     Draw and label a picture. Let represent the length of the two matching sides perpendicular to the river bank, and let represent the single long side running parallel to the river bank.     Find the objective function. We want to maximize the total area enclosed, :      Identify the constraints. The total perimeter of physical fencing used for the three sides is limited to ft:      Reduce the objective function to one variable. Isolate in our perimeter constraint equation to find . Substituting this value directly back into the area equation simplifies our target objective function to a single variable:      Identify the domain of the objective function. All physical side dimensions must stay positive, meaning . Furthermore, since the total layout fencing is capped at ft and must cover two widths, . This yields a realistic mathematical closed domain interval of .     Differentiate the objective function. Finding the first derivative of with respect to yields:      Find the critical numbers. Setting our derivative to zero: The coordinate value serves as our single interior critical number.     Test the critical numbers. Evaluating the function outputs at the interval boundaries using the Closed Interval Method:  sq ft  sq ft  sq ft  The point produces the absolute highest possible area output.     Answer the question. Substituting our optimal width ft back into the constraint equation determines our final parameter requirement:   The optimal dimensions of the field are a width of 300 feet (perpendicular to the river) and a length of 600 feet (parallel to the river), producing a maximum possible area of 180,000 square feet .       Rain Gutter Optimization    A long rectangular sheet of metal, inches wide, is to be made into a rain gutter by turning up two sides so that they are perpendicular to the sheet. How many inches should be turned up to give the gutter its greatest capacity?   Cross-section diagram of a rectangular rain gutter with height x on the left and right, and a base width of 12 minus 2x.       We apply our step-by-step problem-solving strategy to maximize the cross-sectional capacity:     Draw and label a picture. Let represent the length (in inches) of the metal sheet turned up on each side to create the vertical walls of the gutter.     Find the objective function. The volume capacity of a long gutter is directly proportional to its cross-sectional area, . We want to maximize this rectangular area:      Identify the constraints. The total flat width of the initial sheet of metal is fixed at inches. Subtracting the two vertical side bends of length leaves an available interior base width of:      Reduce the objective function to one variable. Substituting the base expression into our geometric area function yields a clean, single-variable objective equation:      Identify the domain of the objective function. The length turned up must be non-negative ( ). Additionally, turning up both sides cannot consume more than the total original width of the sheet, meaning . This outlines our realistic mathematical interval domain as .     Differentiate the objective function. Finding the first derivative of with respect to yields:      Find the critical numbers. We evaluate when the derivative is equal to zero: The value is our single interior critical number.     Test the critical numbers. We apply the Closed Interval Method to verify the maximum profile bounds:  square inches.  square inches.  square inches.  The mathematical max capacity strictly corresponds to the critical point value .     Answer the question. The parameter requiring evaluation is how many inches should be turned up.  To give the gutter its greatest capacity, exactly 3 inches of the metal sheet should be turned up on each side.       Cylindrical Can Optimization    A cylindrical can is to be made to hold of oil. Find the dimensions that will minimize the cost of the metal to manufacture the can.   A 3D perspective diagram of a cylindrical can showing the radius r on the top circular lid and height h along the vertical edge.       We apply our structured 9-step max-min strategy to minimize material manufacturing costs:     Draw and label a picture. Let represent the radius of the circular base and top lid (in centimeters), and let represent the vertical height of the cylinder (in centimeters).     Find the objective function. Minimizing the cost of the manufacturing metal means minimizing the total surface area, , of the closed cylinder:      Identify the constraints. The volume capacity is fixed at . Converting this to standard geometric metrics gives :      Reduce the objective function to one variable. Isolating in our volume constraint formula gives . Substituting this directly into the area objective equation yields:      Identify the domain of the objective function. Because the radius must be physically real, . There is no upper restriction on the radius, so the physical domain is the open interval .     Differentiate the objective function. Differentiating with respect to yields:      Find the critical numbers. We set the first derivative to zero to locate potential extrema: Taking the cube root reveals our single interior critical number:      Test the critical numbers. We apply the Second Derivative Test to confirm a minimum point: Since , the value of is always strictly positive, which indicates that the curve is concave up everywhere on its domain. This verifies that our critical value creates an absolute minimum.     Answer the question. Substituting the optimal radius back into our isolated height constraint: Evaluating the numerical dimensions gives:   To minimize the cost of the manufacturing metal, the can should be designed so that its height is exactly twice its radius ( ), yielding a radius of approximately 5.42 cm and a height of approximately 10.84 cm .       Cylindrical Cost Optimization    A circular cylindrical container, open at the top, is to have a capacity of . The cost of the material used for the bottom of the container is cents per and that of the material used for the curved part is cents per . If there is no waste of material, find the dimensions that will minimize the cost of the material.   An open-top cylindrical container showing a radius r on the bottom base and a height h along the side panel.       We apply our structured 9-step max-min strategy to minimize total component costs:     Draw and label a picture. Let represent the radius of the circular base (in inches) and represent the vertical height of the cylinder (in inches).     Find the objective function. We want to minimize the total material manufacturing cost, , in cents. The cost is the sum of the base cost and the side panel cost:       Identify the constraints. The target capacity volume of the open cylinder is constrained to exactly :      Reduce the objective function to one variable. Simplifying the volume constraint equation allows us to isolate : Substituting this back into our cost expression removes the independent variable height dimension:      Identify the domain of the objective function. The physical radius must be positive, and there is no maximum mathematical restriction. The domain is the open interval .     Differentiate the objective function. Taking the derivative of with respect to yields:      Find the critical numbers. We set the first derivative to zero: The single interior critical number is inches.     Test the critical numbers. We apply the Second Derivative Test to confirm a minimum cost value: Evaluating at our critical number: . Since the second derivative is positive, the function is concave up, verifying an absolute minimum.     Answer the question. Substituting the optimal radius inches back into the constraint equation yields the height parameter:   The dimensions that will minimize the total material cost are a radius of 2 inches and a height of 6 inches .       Cylinder in Sphere Optimization   Find the dimensions of the right circular cylinder of greatest volume that can be inscribed in a sphere of radius .    A 3D transparent wireframe sphere of radius 3 enclosing a blue inscribed right circular cylinder with radius r and height h.     A 2D cross-section view showing a rectangle inscribed inside a circle of radius 3. A right triangle links the origin to a corner with hypotenuse 3, base r, and height h over 2.       We use our 9-step max-min process, mapping the 3D dimensions to the 2D cross-section right triangle:     Draw and label a picture. Let be the radius of the cylinder and be its overall height. Looking at the 2D cross-section slicing through the center, the cylinder appears as an inscribed rectangle of width and height inside a circle of radius .     Find the objective function. We want to maximize the total internal volume, , of a standard cylinder:      Identify the constraints. From the origin out to a corner of the cylinder, a right triangle is formed with a base of , a vertical height of , and a hypotenuse equal to the sphere's radius, . Applying the Pythagorean theorem yields:      Reduce the objective function to one variable. It is easiest to isolate in the constraint equation: . Substituting this directly into the volume objective equation removes the radius variable:      Identify the domain of the objective function. The vertical height must be positive, and it cannot exceed the total diameter of the surrounding sphere. This bounds our independent variable to the closed interval .     Differentiate the objective function. Differentiating with respect to yields:      Find the critical numbers. We set the first derivative to zero: Taking the square root gives our single meaningful interior critical number:      Test the critical numbers. Evaluating the boundary interval endpoints alongside our critical number using the Closed Interval Method:     The height value yields the absolute maximum possible volume.     Answer the question. Find the matching radius component by substituting back into our isolated constraint relationship formula:   The dimensions that yield the maximum cylinder volume are a radius of and a height of .       Cylinder in Cone Optimization   Find the maximum volume of a right circular cylinder that can be inscribed in a cone of altitude centimeters and base radius centimeters, if the axes of the cylinder and cone coincide.    A 3D perspective projection of an outer cone of height 12 and base radius 4 enclosing an inscribed cylinder of radius r and height h.     A 2D cross-section view showing a rectangle inscribed inside an isosceles triangle. Similar triangles link the height of the cone, its base radius, and the variables r and h.       We use our 9-step max-min process, utilizing similar triangles from the cross-section to build the constraint:     Draw and label a picture. Let represent the radius of the inscribed cylinder and represent its height. The 2D cross-section cutting vertically through the vertex shows a rectangle inscribed inside an isosceles triangle of base width and altitude .     Find the objective function. We want to maximize the total volume, , of the cylinder:      Identify the constraints. Looking at the right-hand side of the vertical center axis in the cross-section diagram, the small top triangle is similar to the large overall right triangle. This sets up a proportional geometric ratio:      Reduce the objective function to one variable. Isolating in our proportion yields . Substituting this directly into the cylinder volume objective formula eliminates the height variable:      Identify the domain of the objective function. The cylinder's radius must be non-negative, and it cannot exceed the total base radius of the surrounding cone. This limits our independent variable to the closed interval .     Differentiate the objective function. Differentiating with respect to yields:      Find the critical numbers. We set the first derivative to zero: The value serves as our single interior critical number.     Test the critical numbers. Evaluating the boundary interval endpoints alongside our interior critical number using the Closed Interval Method:     The radius value yields the absolute maximum possible volume.     Answer the question. The problem asks for the maximum volume of the cylinder.   The maximum volume of a right circular cylinder inscribed within the specified cone is exactly (or approximately 89.36 cubic centimeters ).       Closest Point    Find the point on the parabola that is closest to the point .   A plot of the horizontal parabola x equals y squared over 2. The external point (1,4) is plotted, along with a line segment connecting it to the closest point on the curve at (2,2).       We use our 9-step max-min strategy to solve this distance optimization problem:     Draw and label a picture. Let represent an arbitrary point lying directly on the parabola curve , as sketched in the figure. We are looking for the coordinates that minimize the distance to the static coordinate point .     Find the objective function. By the standard distance formula, the distance between and is: To make the calculus cleaner, we can choose to optimize the square of the distance, , because the value that minimizes the squared distance will also minimize the true distance:      Identify the constraints. The point must remain strictly bound to the parabola, which gives us our constraint equation:      Reduce the objective function to one variable. Substituting the expression for directly into the squared-distance objective equation leaves us with a single independent variable equation in terms of : Expanding the algebraic components yields:      Identify the domain of the objective function. The vertical coordinate value can technically be any real number along the continuous open tracking interval, making our domain .     Differentiate the objective function. Differentiating with respect to using the power rule yields:      Find the critical numbers. We set the first derivative to zero: The coordinate value serves as our single real interior critical number.     Test the critical numbers. We apply the First Derivative Test around our critical number :  For , (the distance squared function is decreasing).  For , (the distance squared function is increasing).  Since the derivative changes sign from negative to positive at , it represents an absolute minimum.     Answer the question. Substituting the optimal vertical parameter back into our isolated curve constraint formula calculates the remaining coordinate value:   The point on the parabola that is closest to is exactly .      "
},
{
  "id": "ex-train-display-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-train-display-optimization",
  "type": "Example",
  "number": "264",
  "title": "",
  "body": "   A hobby store has ft of fencing to fence off a rectangular area for an electric train in one corner of its display room. The two sides up against the wall require no fence. What dimensions of the rectangle will maximize the area? What is the maximum area?   A rectangular region enclosed in the top-right corner of a room, labeled with width x and length y, with the outer sides representing the fence.       We apply our structured strategy to optimize the corner layout:     Draw and label a picture. Let represent the width of the enclosed display and represent its length. Because the layout sits in a corner, only one width side and one length side require actual fencing.     Find the objective function. We want to maximize the total floor area, :      Identify the constraints. The structural boundary is limited by our total physical fencing length:      Reduce the objective function to one variable. Isolate in the constraint equation to get . Substituting this expression back into our area equation creates a single independent variable target:      Identify the domain of the objective function. Length parameters must remain positive, meaning . Because the fence total is capped at ft, . This limits our mathematical search scope to the closed domain interval .     Differentiate the objective function. Taking the first derivative with respect to yields:      Find the critical numbers. Setting the derivative to zero: The value is our single interior critical number.     Test the critical numbers. Applying the Closed Interval Method across our domain boundary points:  sq ft  sq ft  sq ft  The mathematical maximum occurs when .     Answer the question. Setting ft requires a corresponding length side of ft.  The optimal dimensions for the train enclosure are 10 ft by 10 ft , producing an absolute maximum area of 100 sq ft .     "
},
{
  "id": "ex-cardboard-box-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-cardboard-box-optimization",
  "type": "Example",
  "number": "265",
  "title": "",
  "body": "  From a square piece of cardboard measuring in. by in., square corners are cut out so that the sides can be folded up to make an open-top box. What dimensions will yield a box with the maximum volume? What is the maximum volume?    A square sheet of cardboard with corners marked as small squares of side length x. Dashed lines indicate where the flaps fold up to form a box.     A 3D perspective drawing of an open-top rectangular box with height x and base dimensions labeled 8 minus 2x.       We execute our step-by-step max-min problem-solving strategy:     Draw and label a picture. Let represent the side length of the square corners being removed. When the four flaps are folded up along the dashed lines, becomes the absolute vertical height of the resulting open box.     Find the objective function. The volume of a rectangular prism is given by:      Identify the constraints. The initial length and width of the cardboard sheet are both inches. Cutting out two corners of size from each dimension reduces both the remaining interior base length and width to .     Reduce the objective function to one variable. Substituting our expressions for height, width, and length into the volume formula leaves us with a single independent variable equation:      Identify the domain of the objective function. The cutout height must be positive ( ). Additionally, because you cannot cut out more than half of the total width of the cardboard sheet, . The continuous closed domain interval is .     Differentiate the objective function. Taking the derivative with respect to :      Find the critical numbers. We set the first derivative to zero and factor the expression: This reveals critical numbers at and . Both values lie within our established interval.     Test the critical numbers. We use the Closed Interval Method to evaluate the volume output:  cubic inches.  cubic inches.  cubic inches.  The maximum volume is generated at the peak value .     Answer the question. The optimal height is in. The base dimensions are:   The maximum volume is achieved when the box has dimensions of 5.33 in. by 5.33 in. by 1.33 in. , yielding a total maximum volume of 9.48 cubic inches (or exactly ).     "
},
{
  "id": "ex-minimize-surface-area",
  "level": "2",
  "url": "sec-Optimization.html#ex-minimize-surface-area",
  "type": "Example",
  "number": "266",
  "title": "",
  "body": "   A container firm is designing an open-top rectangular box, with a square base, that will hold . What dimensions yield the minimum surface area? What is the minimum surface area?   A 3D perspective vector sketch of an open-top rectangular box with a square base of sides x by x and height h.       We apply our structured strategy to minimize structural material:     Draw and label a picture. Let represent the side length of the square base, and let represent the vertical height of the box.     Find the objective function. We want to minimize the total surface area, . Since the box is open-top, it consists of one square base and four identical vertical sides:      Identify the constraints. The volume of the box is fixed at :      Reduce the objective function to one variable. Isolating in the volume constraint gives . Substituting this into our surface area equation gives:      Identify the domain of the objective function. The base dimension must be positive, and there is no upper algebraic restriction. Thus, the physical domain is the open interval .     Differentiate the objective function. Taking the first derivative with respect to yields:      Find the critical numbers. Setting the derivative equal to zero: The value is our single interior critical number.     Test the critical numbers. We apply the Second Derivative Test: Evaluating at our critical number: . Because the second derivative is positive, the graph is concave up, confirming that provides an absolute minimum.     Answer the question. Substituting back into our constraint formula yields the height: The minimum surface area value is:   The optimal dimensions are a base of 6 cm by 6 cm and a height of 3 cm , yielding a minimum surface area of 108 cm .     "
},
{
  "id": "ex-minimize-perimeter",
  "level": "2",
  "url": "sec-Optimization.html#ex-minimize-perimeter",
  "type": "Checkpoint",
  "number": "267",
  "title": "Minimize Perimeter.",
  "body": " Minimize Perimeter    What is the smallest perimeter possible for a rectangle whose area is and what are its dimensions?   A simple rectangle with width labeled x and height labeled y, illustrating the perimeter optimization parameters.       We execute our step-by-step max-min strategy:     Draw and label a picture. Let represent the width of the rectangle, and let represent its height.     Find the objective function. We want to minimize the total perimeter, :      Identify the constraints. The area of the rectangular region is fixed at :      Reduce the objective function to one variable. Solving the constraint equation for yields . Substituting this into the perimeter equation gives:      Identify the domain of the objective function. The physical length must be strictly greater than zero, with no upper restriction. The domain is the open interval .     Differentiate the objective function. Differentiating with respect to gives:      Find the critical numbers. Setting the derivative to zero: (We discard the negative root since it falls outside our geometric domain).     Test the critical numbers. We apply the First Derivative Test around our critical number on the interval :  For , test : (decreasing).  For , test : (increasing).  Because the derivative switches from negative to positive, is an absolute minimum point.     Answer the question. Using our constraint equation, the remaining side is . The absolute minimum perimeter value is:   The smallest possible perimeter is 16 inches , achieved by a square with dimensions of 4 in. by 4 in.      "
},
{
  "id": "ex-river-fence-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-river-fence-optimization",
  "type": "Checkpoint",
  "number": "268",
  "title": "River Fence Optimization.",
  "body": " River Fence Optimization    A farmer has ft of fencing and wants to fence off a rectangular field that borders a straight river. He needs no fence along the river. What are the dimensions of the field that has the largest area?   A rectangular plot bordering a straight blue river on top. The three sides of fencing are labeled with width x and length y.       We apply our structured max-min strategy to maximize the pasture area:     Draw and label a picture. Let represent the length of the two matching sides perpendicular to the river bank, and let represent the single long side running parallel to the river bank.     Find the objective function. We want to maximize the total area enclosed, :      Identify the constraints. The total perimeter of physical fencing used for the three sides is limited to ft:      Reduce the objective function to one variable. Isolate in our perimeter constraint equation to find . Substituting this value directly back into the area equation simplifies our target objective function to a single variable:      Identify the domain of the objective function. All physical side dimensions must stay positive, meaning . Furthermore, since the total layout fencing is capped at ft and must cover two widths, . This yields a realistic mathematical closed domain interval of .     Differentiate the objective function. Finding the first derivative of with respect to yields:      Find the critical numbers. Setting our derivative to zero: The coordinate value serves as our single interior critical number.     Test the critical numbers. Evaluating the function outputs at the interval boundaries using the Closed Interval Method:  sq ft  sq ft  sq ft  The point produces the absolute highest possible area output.     Answer the question. Substituting our optimal width ft back into the constraint equation determines our final parameter requirement:   The optimal dimensions of the field are a width of 300 feet (perpendicular to the river) and a length of 600 feet (parallel to the river), producing a maximum possible area of 180,000 square feet .     "
},
{
  "id": "ex-rain-gutter-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-rain-gutter-optimization",
  "type": "Checkpoint",
  "number": "269",
  "title": "Rain Gutter Optimization.",
  "body": " Rain Gutter Optimization    A long rectangular sheet of metal, inches wide, is to be made into a rain gutter by turning up two sides so that they are perpendicular to the sheet. How many inches should be turned up to give the gutter its greatest capacity?   Cross-section diagram of a rectangular rain gutter with height x on the left and right, and a base width of 12 minus 2x.       We apply our step-by-step problem-solving strategy to maximize the cross-sectional capacity:     Draw and label a picture. Let represent the length (in inches) of the metal sheet turned up on each side to create the vertical walls of the gutter.     Find the objective function. The volume capacity of a long gutter is directly proportional to its cross-sectional area, . We want to maximize this rectangular area:      Identify the constraints. The total flat width of the initial sheet of metal is fixed at inches. Subtracting the two vertical side bends of length leaves an available interior base width of:      Reduce the objective function to one variable. Substituting the base expression into our geometric area function yields a clean, single-variable objective equation:      Identify the domain of the objective function. The length turned up must be non-negative ( ). Additionally, turning up both sides cannot consume more than the total original width of the sheet, meaning . This outlines our realistic mathematical interval domain as .     Differentiate the objective function. Finding the first derivative of with respect to yields:      Find the critical numbers. We evaluate when the derivative is equal to zero: The value is our single interior critical number.     Test the critical numbers. We apply the Closed Interval Method to verify the maximum profile bounds:  square inches.  square inches.  square inches.  The mathematical max capacity strictly corresponds to the critical point value .     Answer the question. The parameter requiring evaluation is how many inches should be turned up.  To give the gutter its greatest capacity, exactly 3 inches of the metal sheet should be turned up on each side.     "
},
{
  "id": "ex-cylindrical-can-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-cylindrical-can-optimization",
  "type": "Checkpoint",
  "number": "270",
  "title": "Cylindrical Can Optimization.",
  "body": " Cylindrical Can Optimization    A cylindrical can is to be made to hold of oil. Find the dimensions that will minimize the cost of the metal to manufacture the can.   A 3D perspective diagram of a cylindrical can showing the radius r on the top circular lid and height h along the vertical edge.       We apply our structured 9-step max-min strategy to minimize material manufacturing costs:     Draw and label a picture. Let represent the radius of the circular base and top lid (in centimeters), and let represent the vertical height of the cylinder (in centimeters).     Find the objective function. Minimizing the cost of the manufacturing metal means minimizing the total surface area, , of the closed cylinder:      Identify the constraints. The volume capacity is fixed at . Converting this to standard geometric metrics gives :      Reduce the objective function to one variable. Isolating in our volume constraint formula gives . Substituting this directly into the area objective equation yields:      Identify the domain of the objective function. Because the radius must be physically real, . There is no upper restriction on the radius, so the physical domain is the open interval .     Differentiate the objective function. Differentiating with respect to yields:      Find the critical numbers. We set the first derivative to zero to locate potential extrema: Taking the cube root reveals our single interior critical number:      Test the critical numbers. We apply the Second Derivative Test to confirm a minimum point: Since , the value of is always strictly positive, which indicates that the curve is concave up everywhere on its domain. This verifies that our critical value creates an absolute minimum.     Answer the question. Substituting the optimal radius back into our isolated height constraint: Evaluating the numerical dimensions gives:   To minimize the cost of the manufacturing metal, the can should be designed so that its height is exactly twice its radius ( ), yielding a radius of approximately 5.42 cm and a height of approximately 10.84 cm .     "
},
{
  "id": "ex-cylindrical-cost-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-cylindrical-cost-optimization",
  "type": "Checkpoint",
  "number": "271",
  "title": "Cylindrical Cost Optimization.",
  "body": " Cylindrical Cost Optimization    A circular cylindrical container, open at the top, is to have a capacity of . The cost of the material used for the bottom of the container is cents per and that of the material used for the curved part is cents per . If there is no waste of material, find the dimensions that will minimize the cost of the material.   An open-top cylindrical container showing a radius r on the bottom base and a height h along the side panel.       We apply our structured 9-step max-min strategy to minimize total component costs:     Draw and label a picture. Let represent the radius of the circular base (in inches) and represent the vertical height of the cylinder (in inches).     Find the objective function. We want to minimize the total material manufacturing cost, , in cents. The cost is the sum of the base cost and the side panel cost:       Identify the constraints. The target capacity volume of the open cylinder is constrained to exactly :      Reduce the objective function to one variable. Simplifying the volume constraint equation allows us to isolate : Substituting this back into our cost expression removes the independent variable height dimension:      Identify the domain of the objective function. The physical radius must be positive, and there is no maximum mathematical restriction. The domain is the open interval .     Differentiate the objective function. Taking the derivative of with respect to yields:      Find the critical numbers. We set the first derivative to zero: The single interior critical number is inches.     Test the critical numbers. We apply the Second Derivative Test to confirm a minimum cost value: Evaluating at our critical number: . Since the second derivative is positive, the function is concave up, verifying an absolute minimum.     Answer the question. Substituting the optimal radius inches back into the constraint equation yields the height parameter:   The dimensions that will minimize the total material cost are a radius of 2 inches and a height of 6 inches .     "
},
{
  "id": "ex-cylinder-in-sphere-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-cylinder-in-sphere-optimization",
  "type": "Checkpoint",
  "number": "272",
  "title": "Cylinder in Sphere Optimization.",
  "body": " Cylinder in Sphere Optimization   Find the dimensions of the right circular cylinder of greatest volume that can be inscribed in a sphere of radius .    A 3D transparent wireframe sphere of radius 3 enclosing a blue inscribed right circular cylinder with radius r and height h.     A 2D cross-section view showing a rectangle inscribed inside a circle of radius 3. A right triangle links the origin to a corner with hypotenuse 3, base r, and height h over 2.       We use our 9-step max-min process, mapping the 3D dimensions to the 2D cross-section right triangle:     Draw and label a picture. Let be the radius of the cylinder and be its overall height. Looking at the 2D cross-section slicing through the center, the cylinder appears as an inscribed rectangle of width and height inside a circle of radius .     Find the objective function. We want to maximize the total internal volume, , of a standard cylinder:      Identify the constraints. From the origin out to a corner of the cylinder, a right triangle is formed with a base of , a vertical height of , and a hypotenuse equal to the sphere's radius, . Applying the Pythagorean theorem yields:      Reduce the objective function to one variable. It is easiest to isolate in the constraint equation: . Substituting this directly into the volume objective equation removes the radius variable:      Identify the domain of the objective function. The vertical height must be positive, and it cannot exceed the total diameter of the surrounding sphere. This bounds our independent variable to the closed interval .     Differentiate the objective function. Differentiating with respect to yields:      Find the critical numbers. We set the first derivative to zero: Taking the square root gives our single meaningful interior critical number:      Test the critical numbers. Evaluating the boundary interval endpoints alongside our critical number using the Closed Interval Method:     The height value yields the absolute maximum possible volume.     Answer the question. Find the matching radius component by substituting back into our isolated constraint relationship formula:   The dimensions that yield the maximum cylinder volume are a radius of and a height of .     "
},
{
  "id": "ex-cylinder-in-cone-optimization",
  "level": "2",
  "url": "sec-Optimization.html#ex-cylinder-in-cone-optimization",
  "type": "Checkpoint",
  "number": "273",
  "title": "Cylinder in Cone Optimization.",
  "body": " Cylinder in Cone Optimization   Find the maximum volume of a right circular cylinder that can be inscribed in a cone of altitude centimeters and base radius centimeters, if the axes of the cylinder and cone coincide.    A 3D perspective projection of an outer cone of height 12 and base radius 4 enclosing an inscribed cylinder of radius r and height h.     A 2D cross-section view showing a rectangle inscribed inside an isosceles triangle. Similar triangles link the height of the cone, its base radius, and the variables r and h.       We use our 9-step max-min process, utilizing similar triangles from the cross-section to build the constraint:     Draw and label a picture. Let represent the radius of the inscribed cylinder and represent its height. The 2D cross-section cutting vertically through the vertex shows a rectangle inscribed inside an isosceles triangle of base width and altitude .     Find the objective function. We want to maximize the total volume, , of the cylinder:      Identify the constraints. Looking at the right-hand side of the vertical center axis in the cross-section diagram, the small top triangle is similar to the large overall right triangle. This sets up a proportional geometric ratio:      Reduce the objective function to one variable. Isolating in our proportion yields . Substituting this directly into the cylinder volume objective formula eliminates the height variable:      Identify the domain of the objective function. The cylinder's radius must be non-negative, and it cannot exceed the total base radius of the surrounding cone. This limits our independent variable to the closed interval .     Differentiate the objective function. Differentiating with respect to yields:      Find the critical numbers. We set the first derivative to zero: The value serves as our single interior critical number.     Test the critical numbers. Evaluating the boundary interval endpoints alongside our interior critical number using the Closed Interval Method:     The radius value yields the absolute maximum possible volume.     Answer the question. The problem asks for the maximum volume of the cylinder.   The maximum volume of a right circular cylinder inscribed within the specified cone is exactly (or approximately 89.36 cubic centimeters ).     "
},
{
  "id": "ex-closest-point-parabola",
  "level": "2",
  "url": "sec-Optimization.html#ex-closest-point-parabola",
  "type": "Checkpoint",
  "number": "274",
  "title": "Closest Point.",
